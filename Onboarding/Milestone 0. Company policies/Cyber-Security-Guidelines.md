...
Password manager--> it does it automatically. Setting up screen auto turn off when inactivity. Have auto lock and biometric (already)
...
Email or message the team/supervisor about the security breach. Change password.
